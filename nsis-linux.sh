...
mkdir -p /tmp/nsis && curl -L https://sourceforge.net/projects/nsis/files/NSIS%203/3.02.1/nsis-3.02.1-src.tar.bz2/download | tar -xj -C /tmp/nsis --strip-components 1
cd /tmp/nsis
