...
update-appimage-runtime:
	curl -L https://github.com/AppImage/type2-runtime/releases/download/20251108/runtime-x86_64 -o AppImage/runtime-x64
	curl -L https://github.com/AppImage/type2-runtime/releases/download/20251108/runtime-i686 -o AppImage/runtime-ia32
	curl -L https://github.com/AppImage/type2-runtime/releases/download/20251108/runtime-aarch64 -o AppImage/runtime-arm64
	curl -L https://github.com/AppImage/type2-runtime/releases/download/20251108/runtime-armhf -o AppImage/runtime-armv7l
